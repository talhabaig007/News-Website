<?php
/**
 * Includes widget fields, render contents and callbacks for post list layout.  
 * 
 */
class Wpblog_Post_Layouts_List_Element extends \Elementor\Widget_Base {

    /**
     * @return - name of the widget
     */
    public function get_name() {
        return 'cv-list-blog-post-layout';
    }
    ...
    public function get_title() {
        return esc_html__( 'CV List Post Layout', 'wp-blog-post-layouts' );
    }
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    [
                        'value' => 'layout-one',
                        'label' => esc_url( WPBLOG_POST_LAYOUTS_INCLUDES_URL . '/assets/images/list-layout-one.png' ),
                    ],
                    [
                        'value' => 'layout-two',
                        'label' => esc_url( WPBLOG_POST_LAYOUTS_INCLUDES_URL . '/assets/images/list-layout-two.png' ),
                    ],
                    [
                        'value' => 'layout-three',
                        'label' => esc_url( WPBLOG_POST_LAYOUTS_INCLUDES_URL . '/assets/images/list-layout-three.png' ),
                    ]
                ],
            ]
        );
    ...
    protected function render() {
        ...
        echo '<div id="cv-list-post-layout" class="block-'.esc_html( $element_id ).' cv-block cv-block-list--'.esc_html( $layoutOption ).'">';
            if( !empty( $blockTitle ) ) {
