...
class Wpblog_Post_Layouts_Masonry_Element extends \Elementor\Widget_Base {
    ...
    protected function render() {
        ...
        echo '<div id="cv-masonry-post-layout" class="block-'.esc_html( $element_id ).' cv-block cv-masonry-post-layout cv-block-masonry--'.esc_html( $layoutOption ).' cv-block-grid--'.esc_html( $layoutOption ).'">';
            if( !empty( $blockTitle ) ) {
