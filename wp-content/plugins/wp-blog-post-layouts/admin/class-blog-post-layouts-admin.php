            ...
            <div id="cv-blog-post-layouts-admin" class="cv-admin-block-wrapper cv-clearfix">
                ...
                <footer id="cv-main-footer" class="cv-promo-sidebar">
                    <div class="footer-content cv-promo-block">
                        ...
                        <a href="<?php echo esc_url( 'https://codevibrant.com/pricing/?product_id=14492' ); ?>" target="_blank" class="button button-primary"><?php esc_html_e( 'Upgrade Now', 'wp-blog-post-layouts' ); ?></a>
                    </div><!-- .footer-content -->
        ...
        public function upgrade_admin_notice() {
            ...
            ?>
                <div id="cv-plugin-admin-notice" class="notice updated is-dismissible">
                    ...
                    <div class="links">
                        <a href="<?php echo esc_url( 'https://codevibrant.com/pricing/?product_id=14492' ); ?>" class="btn button-primary" target="_blank">
