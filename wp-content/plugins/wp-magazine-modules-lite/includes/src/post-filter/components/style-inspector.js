            ...
            <Fragment>
                <PanelBody title={ escapeHTML( __( 'Layout Settings', 'wp-magazine-modules-lite' ) ) } initialOpen = { false }>
                    <div className="cvmm-layout-button-group">
                        ...
                        <div>
                            <Button className={ `${( blockLayout == 'layout-default') ? "isActive" : "" }` } onClick={ ( e ) => setAttributes( { blockLayout: 'layout-default' } ) } ><img src={ BlocksBuildObject.filterLayoutDefault } /></Button>
                            <Button className={ `${( blockLayout == 'layout-one') ? "isActive" : "" }` } onClick={ ( e ) => setAttributes( { blockLayout: 'layout-one' } ) }><img src={ BlocksBuildObject.filterLayoutOne } /></Button>
                        </div>
                    </div>
                    <ToggleControl
                ...
                <PanelBody title={ escapeHTML( __( 'Typography Settings', 'wp-magazine-modules-lite' ) ) } initialOpen = { false } >
                    ...
                    <PanelBody className="cvmm-editor-component-sub-panel_body" title={ escapeHTML( __( 'Tab Title', 'wp-magazine-modules-lite' ) ) } initialOpen = { false } >
                        <SelectControl
                            label={ escapeHTML( __( 'Text Align', 'wp-magazine-modules-lite' ) ) }
                            value={ tabTitleTextAlign }
                            options={ [
                            ...
                            onChange={ ( newtabTitleTextAlign ) => setAttributes( { tabTitleTextAlign: newtabTitleTextAlign } ) }
                        />
                        <SelectControl
                            label={ escapeHTML( __( 'Font Family', 'wp-magazine-modules-lite' ) ) }
                            value={ tabTitleFontFamily }
                            options={ googleFontsOptions }
                            onChange={ ( newtabTitleFontFamily ) => setAttributes( { tabTitleFontFamily: newtabTitleFontFamily, tabTitleFontWeight: setfontWeight( newtabTitleFontFamily, google_fonts )[0].value } ) }
                        />
                        { titleFontFamily &&
                            <SelectControl
                                label={ escapeHTML( __( 'Font Weight', 'wp-magazine-modules-lite' ) ) }
                                value={ tabTitleFontWeight }
                                options={ setfontWeight( tabTitleFontFamily, google_fonts ) }
                                onChange={ ( newtabTitleFontWeight ) => setAttributes( { tabTitleFontWeight: newtabTitleFontWeight } ) }
                            />
                        }
                        <RangeControl
                            label={ escapeHTML( __( 'Font Size', 'wp-magazine-modules-lite' ) ) }
                            value={ tabTitleFontSize }
                            onChange={ ( newtabTitleFontSize ) => setAttributes( { tabTitleFontSize: newtabTitleFontSize } ) }
                            min={ 1 }
                            max={ 200 }
                            allowReset={ true }
                            initialPosition = { 0 }
                        ...
                        <SelectControl
                            ...
                            onChange={ ( newtabTitleFontStyle ) => setAttributes( { tabTitleFontStyle: newtabTitleFontStyle } ) }
                        />
                        <SelectControl
                            label={ escapeHTML( __( 'Text Transform', 'wp-magazine-modules-lite' ) ) }
                            ...
                            onChange={ ( newtabTitleTextTransform ) => setAttributes( { tabTitleTextTransform: newtabTitleTextTransform } ) }
                        />
                        <SelectControl
                            label={ escapeHTML( __( 'Text Decoration', 'wp-magazine-modules-lite' ) ) }
                            value={ tabTitleTextDecoration }
                            options={ [
                                { value: 'none', label: escapeHTML( __( 'None', 'wp-magazine-modules-lite' ) ) },
                                { value: 'underline', label: escapeHTML( __( 'Underline', 'wp-magazine-modules-lite' ) ) },
                                { value: 'line-through', label: escapeHTML( __( 'Line-through', 'wp-magazine-modules-lite' ) ) },
                            ...
                            onChange={ ( newtabTitleTextDecoration ) => setAttributes( { tabTitleTextDecoration: newtabTitleTextDecoration } ) }
                        />
                        <div class="cvmm-title-color-wrap">
                            <label>{ escapeHTML( __( 'Font Color', 'wp-magazine-modules-lite' ) ) }</label>
                            <ColorPalette
                                colors={colors}
                                value={ tabTitleFontColor }
                                onChange={ ( newtabTitleFontColor ) => setAttributes( { tabTitleFontColor: newtabTitleFontColor } ) }
                            />
                            <label>{ escapeHTML( __( 'Hover Color', 'wp-magazine-modules-lite' ) ) }</label>
                            <ColorPalette
                                colors={colors}
                                value={ tabTitleHoverColor }
                                onChange={ ( newtabTitleHoverColor ) => setAttributes( { tabTitleHoverColor: newtabTitleHoverColor } ) }
                            />
                        </div>
                        <RangeControl
                            label={ escapeHTML( __( 'Line Height', 'wp-magazine-modules-lite' ) ) }
                            value={ tabTitlelineHeight }
                            onChange={ ( newtabTitlelineHeight ) => setAttributes( { tabTitlelineHeight: newtabTitlelineHeight } ) }
                            step={ 0.1 }
                            min={ 0.1 }
                            max={ 10 }
                            allowReset={ true }
