<?php
/**
 * Template for post filter default layout
 * 
...
?>
    <article post-id="post-<?php echo esc_attr( $post_id ); ?>" class="cvmm-post post-format--<?php echo esc_html( $post_format ); ?> <?php echo esc_html( $filterpostclass ); ?>" itemscope itemtype="<?php echo esc_url( 'http://schema.org/articleBody' ); ?>">
        <?php
            if( $thumbOption ) :
