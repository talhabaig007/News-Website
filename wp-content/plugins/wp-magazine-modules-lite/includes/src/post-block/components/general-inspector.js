...
class GeneralInspector extends Component {
    ...
    render() {
        const { blockTitle, blockTitleLayout, blockTitleAlign, postCategory, postCount, contentOption, contentType, wordCount, buttonOption, buttonLabel, orderBy, order, dateOption, authorOption, categoryOption, categoriesCount, tagsOption, tagsCount, commentOption, permalinkTarget, fallbackImage } = this.props.attributes;
