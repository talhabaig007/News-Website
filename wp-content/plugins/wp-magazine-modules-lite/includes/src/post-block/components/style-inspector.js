            ...
            <Fragment>
                <PanelBody title={ escapeHTML( __( 'Layout Settings', 'wp-magazine-modules-lite' ) ) } initialOpen = { false }>
                    <div className="cvmm-layout-button-group">
                        ...
                        <div>
                            <Button className={ `${( blockLayout == 'layout-one') ? "isActive" : "" }` } onClick={ ( e ) => setAttributes( { blockLayout: 'layout-one' } ) }><img src={ BlocksBuildObject.blockLayoutOne } /></Button>
                            <Button className={ `${( blockLayout == 'layout-two') ? "isActive" : "" }` } onClick={ ( e ) => setAttributes( { blockLayout: 'layout-two' } ) } ><img src={ BlocksBuildObject.blockLayoutTwo } /></Button>
                        </div>
                    </div>
                    <ToggleControl
