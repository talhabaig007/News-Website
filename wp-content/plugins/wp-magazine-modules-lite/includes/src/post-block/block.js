...
registerBlockType( 'wpmagazine-modules/post-block', {
    title: escapeHTML( __( 'WP Magazine Post Block', 'wp-magazine-modules-lite' ) ),
    description: escapeHTML( __( 'Post collection with block layout', 'wp-magazine-modules-lite' ) ),
    icon: {
        background: '#fff',
