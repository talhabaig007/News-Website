 ...
 * Block View wrapper
 */
import PostGridDefault from '../layout-default/layout-default'
import PostGridOne from '../layout-one/layout-one'
...
export default class Edit extends Component {
    ...
    render() {
        ...
        if( !typographyOption ) {
            ...
            blockStyle +=' .block-' + blockID + ' .cvmm-read-more{text-align: ' + buttonTextAlign + '}'

            blockStyle +=' .block-' + blockID + ' .cvmm-read-more a:hover{color: ' + buttonHoverColor + ';background-color: ' + buttonBackgroundHoverColor + ';border-color: ' + buttonBorderHoverColor + '}'
        } else {
            ...
            blockStyle +=' .block-' + blockID + ' .cvmm-read-more a:hover{border-color: ' + blockHoverColor + '}';
        }
        ...
        return (
            <Fragment>
                ...
                <div id={ `wpmagazine-modules-lite-post-grid-block-${blockID}` } className={ `wpmagazine-modules-lite-post-grid-block block-${blockID} cvmm-block cvmm-block-post-grid--${blockLayout}` }>
                    { blockTitle &&
                    ...
                    }
                    {
                        ( () => {
                            switch( blockLayout ) {
                                case 'layout-one' : return <PostGridOne { ...this.props }/>
                                default: return <PostGridDefault { ...this.props }/>
                            }
                        }) ()
                    }
                </div>
