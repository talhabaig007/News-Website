 ...
 * 
 */
if( !class_exists( 'Wpmagazine_Modules_Lite_Post_Grid' ) ) :
    class Wpmagazine_Modules_Lite_Post_Grid extends Wpmagazine_Modules_Lite_Block_Base {
        /**z
         * Name of block
         * 
         * @access protected
         ...
         * 
         */
        protected $block_name = 'post-grid';
        ...
        public function render_callback( $attributes ) {
            ob_start();
                extract( $attributes );
            ?>
                <div id="wpmagazine-modules-lite-post-grid-block-<?php echo esc_attr( $blockID ); ?>" class="wpmagazine-modules-lite-post-grid-block align<?php echo esc_html( $align ); ?> block-<?php echo esc_attr( $blockID ); ?> cvmm-block cvmm-block-post-grid--<?php echo esc_html( $blockLayout ); ?>">
                    <?php
                        if( !empty( $blockTitle ) ) {
    ...
    Wpmagazine_Modules_Lite_Post_Grid::instance();
endif;