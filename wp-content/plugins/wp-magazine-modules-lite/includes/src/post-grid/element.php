 ...
 * 
 */
class Wpmagazine_Modules_Lite_Post_Grid_Element extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'WP Magazine Post Grid', 'wp-magazine-modules-lite' );
    }
    ...
    public function get_icon() {
        return 'cvicon-item cvicon-grid';
    }
            ...
            [
                ...
                'options' => [
                    [
                        ...
                        'label' => esc_url( WPMAGAZINE_MODULES_LITE_INCLUDES_URL . '/assets/images/grid-layout-default.png' ),
                    ],
                    [
                        'value' => 'layout-one',
                        'label' => esc_url( WPMAGAZINE_MODULES_LITE_INCLUDES_URL . '/assets/images/grid-layout-one.png' ),
                    ]
                ],
            ]
        );
    ...
    protected function render() {
        ...
        echo '<div id="wpmagazine-modules-lite-post-grid-block-'.esc_html( $element_id ).'" class="wpmagazine-modules-lite-post-grid-block block-'.esc_html( $element_id ).' cvmm-block cvmm-block-post-grid--'.esc_html( $blockLayout ).'">';
            if( !empty( $blockTitle ) ) {
        ...
        echo '</div><!-- #wpmagazine-modules-lite-post-grid-block -->';
    }
}