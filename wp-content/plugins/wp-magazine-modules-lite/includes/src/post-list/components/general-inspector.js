...
const { PanelBody, TextControl, SelectControl, RangeControl, ToggleControl, Button, Spinner, CheckboxControl } = wp.components;
    ...
    render() {
        ...
        return (
            <Fragment>
                ...
                <PanelBody title={ escapeHTML( __( 'Query Settings', 'wp-magazine-modules-lite' ) ) } initialOpen = { true }>
                    <RangeControl
...
export default withSelect( ( select, props ) => {
    ...
    const taxonomnyQuery = {
        hide_empty: true,
        per_page: 100
    }
    return {
        categoriesList: getEntityRecords( 'taxonomy', taxonomnyName, taxonomnyQuery ),
    };
} )( GeneralInspector );