...
registerBlockType( 'wpmagazine-modules/post-list', {
    title: escapeHTML( __( 'WP Magazine Post List', 'wp-magazine-modules-lite' ) ),
    description: escapeHTML( __( 'Post collection with list layout', 'wp-magazine-modules-lite' ) ),
    icon: {
        background: '#fff',
    ...
    keywords: [
        escapeHTML( __( 'list', 'wp-magazine-modules-lite' ) ),
