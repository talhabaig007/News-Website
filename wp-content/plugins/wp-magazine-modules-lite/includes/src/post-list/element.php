 ...
 * 
 */
class Wpmagazine_Modules_Lite_Post_List_Element extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'WP Magazine Post List', 'wp-magazine-modules-lite' );
    }
    ...
    public function get_icon() {
        return 'cvicon-item cvicon-list';
    }
            ...
            [
                ...
                'options' => [
                    [
                        ...
                        'label' => esc_url( WPMAGAZINE_MODULES_LITE_INCLUDES_URL . '/assets/images/list-layout-default.png' ),
                    ],
                    [
                        'value' => 'layout-one',
                        'label' => esc_url( WPMAGAZINE_MODULES_LITE_INCLUDES_URL . '/assets/images/list-layout-one.png' ),
                    ]
                ],
            ]
        );
    ...
    protected function render() {
        ...
        echo '<div id="wpmagazine-modules-lite-post-list-block-'.esc_html( $element_id ).'" class="wpmagazine-modules-lite-post-list-block block-'.esc_html( $element_id ).' cvmm-block cvmm-block-post-list--'.esc_html( $blockLayout ).'">';
            if( !empty( $blockTitle ) ) {
        ...
        echo '</div><!-- #wpmagazine-modules-lite-post-list-block -->';
    }
}