/**
 * Post Carousel block layout default - editor preview
 */
...
class PostCarouselDefault extends Component {
    constructor( props ) {
        super(...arguments)
    }
    ...
    render() {
        ...
        let settings = {
            ...
            slidesToScroll: 1,
            nextArrow: <span className="slickArrow prev-icon"><i class="fas fa-chevron-right"></i></span>,
            prevArrow: <span className="slickArrow next-icon"><i class="fas fa-chevron-left"></i></span>
        }
