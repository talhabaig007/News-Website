 ...
 * Block View wrapper
 */
import PostCarouselDefault from '../layout-default/layout-default'
import PostCarouselOne from '../layout-one/layout-one'
...
export default class Edit extends Component {
    ...
    render() {
        ...
        if( !typographyOption ) {
            ...
            blockStyle +=' .block-' + blockID + ' .cvmm-post-carousel-wrapper .slickArrow.slick-arrow:hover{background-color: ' + blockHoverColor + '}';
        ...
        return (
            <Fragment>
                ...
                <div id="wpmagazine-modules-lite-post-carousel-block" className={ `wpmagazine-modules-lite-post-carousel-block block-${blockID} cvmm-block cvmm-block-post-carousel--${blockLayout}` }>
                    { blockTitle &&
                    ...
                    }
                    {
                        ( () => {
                            switch( blockLayout ) {
                                case 'layout-one' : return <PostCarouselOne { ...this.props }/>
                                default: return <PostCarouselDefault { ...this.props }/>
                            }
                        }) ()
                    }
                </div>
