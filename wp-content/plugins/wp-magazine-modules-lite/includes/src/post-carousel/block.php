    ...
    class Wpmagazine_Modules_Lite_Post_Carousel extends Wpmagazine_Modules_Lite_Block_Base {
        ...
        public function render_callback( $attributes ) {
            ob_start();
                extract( $attributes );
            ?>
                <div id="wpmagazine-modules-lite-post-carousel-block-<?php echo esc_attr( $blockID ); ?>" class="wpmagazine-modules-lite-post-carousel-block align<?php echo esc_html( $align ); ?> block-<?php echo esc_attr( $blockID ); ?> cvmm-block cvmm-block-post-carousel--<?php echo esc_html( $blockLayout ); ?>">
                    <?php
                        if( !empty( $blockTitle ) ) {
