 ...
 * 
 */
class Wpmagazine_Modules_Lite_Post_Carousel_Element extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'WP Magazine Post Carousel', 'wp-magazine-modules-lite' );
    }
    ...
    public function get_icon() {
        return 'cvicon-item cvicon-carousel';
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                'carouselColumn',
                [
                    'label' => esc_html__( 'Carousel Column', 'wp-magazine-modules-lite' ),
                    'type' => \Elementor\Controls_Manager::NUMBER,
                    'min' => 1,
                    'max' => 5,
                    'step' => 1,
            ...
            [
                ...
                'options' => [
                    [
                        ...
                        'label' => esc_url( WPMAGAZINE_MODULES_LITE_INCLUDES_URL . '/assets/images/carousel-layout-default.png' ),
                    ],
                    [
                        'value' => 'layout-one',
                        'label' => esc_url( WPMAGAZINE_MODULES_LITE_INCLUDES_URL . '/assets/images/carousel-layout-one.png' ),
                    ]
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .cvmm-post-carousel-wrapper .slickArrow.slick-arrow:hover' => 'border-color: {{VALUE}};background-color: {{VALUE}} ',
                ],
            ]
        );
        $this->end_controls_section();
    ...
    protected function render() {
        ...
        echo '<div id="wpmagazine-modules-lite-post-carousel-block-'.esc_attr( $element_id ).'" class="wpmagazine-modules-lite-post-carousel-block block-'.esc_html( $element_id ).' cvmm-block cvmm-block-post-carousel--'.esc_html( $blockLayout ).'">';
            if( !empty( $blockTitle ) ) {
        ...
        echo '</div><!-- #wpmagazine-modules-lite-post-carousel-block -->';
    }
}