 ...
 * 
 */
class Wpmagazine_Modules_Lite_Post_Slider_Element extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'WP Magazine Post Slider', 'wp-magazine-modules-lite' );
    }
    ...
    public function get_icon() {
        return 'cvicon-item cvicon-slider';
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    'label' => esc_html__( 'Autoplay Speed', 'wp-magazine-modules-lite' ),
                    'type' => \Elementor\Controls_Manager::NUMBER,
                    'min' => 1000,
                    'max' => 10000,
                    'step' => 100,
            ...
            [
                ...
                'options' => [
                    [
                        ...
                        'label' => esc_url( WPMAGAZINE_MODULES_LITE_INCLUDES_URL . '/assets/images/slider-layout-default.png' ),
                    ],
                    [
                        'value' => 'layout-one',
                        'label' => esc_url( WPMAGAZINE_MODULES_LITE_INCLUDES_URL . '/assets/images/slider-layout-one.png' ),
                    ]
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .cvmm-block-title.layout--two span, {{WRAPPER}} .cvmm-block-post-slider--layout-one .cvmm-post-cat a, {{WRAPPER}} .cvmm-block-post-slider--layout-one .cvmm-post-cat:after' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'default' => '#029FB2',
                'selectors' => [
                    '{{WRAPPER}} .cvmm-post-title a:hover, {{WRAPPER}} .cvmm-read-more a:hover,{{WRAPPER}}  .cvmm-post-meta .cvmm-post-meta-item:hover>a, {{WRAPPER}} .cvmm-post-meta a:hover, {{WRAPPER}} .cvmm-post-meta .cvmm-post-meta-item:hover:before' => 'color: {{VALUE}}',
                    '{{WRAPPER}} .cvmm-slider-post-wrapper .slick-arrow:hover, {{WRAPPER}} .cvmm-slider-post-wrapper .slick-arrow:focus' => 'background: {{VALUE}}',
                ],
            ]
        );
        $this->end_controls_section();
            ...
            $this->start_controls_tabs(
                ...
                $this->add_control(
                    ...
                    [
                        ...
                        'selectors' => [
                            '{{WRAPPER}} .cvmm-post-title' => 'font-family: {{VALUE}}',
                        ],
                        'condition' => [
                            'typographyOption!' => 'show'
                        ]
    ...
    ?>
        <div id="wpmagazine-modules-lite-post-slider-block-<?php echo esc_attr( $element_id ); ?>" class="wpmagazine-modules-lite-post-slider-block block-<?php echo esc_attr( $element_id ); ?> cvmm-block cvmm-block-post-slider--<?php echo esc_html( $blockLayout ); ?>">
            <?php
                if( !empty( $blockTitle ) ) {
