 ...
 * 
 */
class Wpmagazine_Modules_Lite_Post_Masonry_Element extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'WP Magazine Post Masonry', 'wp-magazine-modules-lite' );
    }
    ...
    public function get_icon() {
        return 'cvicon-item cvicon-masonary';
    }
            ...
            [
                ...
                'options' => [
                    [
                        ...
                        'label' => esc_url( WPMAGAZINE_MODULES_LITE_INCLUDES_URL . '/assets/images/masonry-layout-default.png' ),
                    ],
                    [
                        'value' => 'layout-one',
                        'label' => esc_url( WPMAGAZINE_MODULES_LITE_INCLUDES_URL . '/assets/images/masonry-layout-one.png' ),
                    ]
                ],
            ]
        );
            ...
            $this->start_controls_tabs(
                ...
                $this->add_control(
                    ...
                    [
                        ...
                        'selectors' => [
                            '{{WRAPPER}} .cvmm-content' => 'font-family: {{VALUE}}',
                        ],
                        'condition' => [
                            'typographyOption!' => 'show'
                        ]
    ...
    protected function render() {
        ...
        echo '<div id="wpmagazine-modules-lite-post-masonry-block-'.esc_html( $element_id ).'" class="wpmagazine-modules-lite-post-masonry-block block-'.esc_html( $element_id ).' cvmm-block cvmm-block-post-masonry--'.esc_html( $blockLayout ).'">';
            if( !empty( $blockTitle ) ) {
        ...
        echo '</div><!-- #wpmagazine-modules-lite-post-masonry-block -->';
    }
}