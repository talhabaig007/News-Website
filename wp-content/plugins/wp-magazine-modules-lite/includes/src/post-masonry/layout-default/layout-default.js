/**
 * Post Masonry block layout default - editor preview
 */
...
class PostMasonryDefault extends Component {
    constructor( props ) {
        super(...arguments)
    }

    render() {
        const { imageSize, fallbackImage, contentOption, contentType, wordCount, thumbOption, titleOption, dateOption, authorOption , categoryOption, categoriesCount, tagsOption, tagsCount, commentOption, permalinkTarget, buttonOption, buttonLabel, postFormatIcon, postMetaIcon, postButtonIcon, blockColumn, postMargin } = this.props.attributes
        ...
        return <Masonry className={ `cvmm-post-wrapper ${postClass}` }>{ content }</Masonry>
    }
}
