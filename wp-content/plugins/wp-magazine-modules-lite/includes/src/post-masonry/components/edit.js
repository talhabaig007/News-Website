 ...
 * Block View wrapper
 */
import PostMasonryDefault from '../layout-default/layout-default'
import PostMasonryOne from '../layout-one/layout-one'
    ...
    render() {
        ...
        return (
            <Fragment>
                ...
                <div id={ `wpmagazine-modules-lite-post-masonry-block-${blockID}` } className={ `wpmagazine-modules-lite-post-masonry-block block-${blockID} cvmm-block cvmm-block-post-masonry--${blockLayout}` }>
                    { blockTitle &&
                    ...
                    }
                    {
                        ( () => {
                            switch( blockLayout ) {
                                case 'layout-one' : return <PostMasonryOne { ...this.props }/>
                                default: return <PostMasonryDefault { ...this.props }/>
                            }
                        }) ()
                    }
                </div>
