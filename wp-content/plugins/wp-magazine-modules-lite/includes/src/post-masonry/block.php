 ...
 * 
 */
if( !class_exists( 'Wpmagazine_Modules_Lite_Post_Masonry' ) ) :
    class Wpmagazine_Modules_Lite_Post_Masonry extends Wpmagazine_Modules_Lite_Block_Base {
        /**z
         * Name of block
         * 
         * @access protected
        ...
        public function render_callback( $attributes ) {
            ob_start();
                extract( $attributes );
            ?>
                <div id="wpmagazine-modules-lite-post-masonry-block-<?php echo esc_attr( $blockID ); ?>" class="wpmagazine-modules-lite-post-masonry-block align<?php echo esc_html( $align ); ?> block-<?php echo esc_attr( $blockID ); ?> cvmm-block cvmm-block-post-masonry--<?php echo esc_html( $blockLayout ); ?>">
                    <?php
                        if( !empty( $blockTitle ) ) {
                ...
                ?>
                </div><!-- #wpmagazine-modules-post-masonry-block -->
        <?php
    ...
    Wpmagazine_Modules_Lite_Post_Masonry::instance();
endif;