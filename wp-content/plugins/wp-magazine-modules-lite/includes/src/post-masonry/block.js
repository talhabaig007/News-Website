...
registerBlockType( 'wpmagazine-modules/post-masonry', {
    title: escapeHTML( __( 'WP Magazine Post Masonry', 'wp-magazine-modules-lite' ) ),
    description: escapeHTML( __( 'Post collection with masonry layout', 'wp-magazine-modules-lite' ) ),
    icon: {
        background: '#fff',
    ...
    keywords: [
        escapeHTML( __( 'masonry', 'wp-magazine-modules-lite' ) ),
        escapeHTML( __( 'post', 'wp-magazine-modules-lite' ) )
    ],
    category: 'wpmagazine-modules-lite',
    attributes: postmasonryAttributes,
