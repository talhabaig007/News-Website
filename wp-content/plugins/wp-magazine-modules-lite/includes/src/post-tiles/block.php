 ...
 * 
 */
if( !class_exists( 'Wpmagazine_Modules_Lite_Post_Tiles' ) ) :
    class Wpmagazine_Modules_Lite_Post_Tiles extends Wpmagazine_Modules_Lite_Block_Base {
        /**
         * Name of block
         * 
         * @access protected
         ...
         * 
         */
        protected $block_name = 'post-tiles';
        ...
        public function get_attributes() {
            $attrs = array(
                ...
                'featuredSectionOption' => array(
                    'type'      => 'boolean',
                    'default'   => false
                ),
                'featuredposttype' => array(
                    'type' => 'string',
                    'default' => 'post'
                ),
                'featuredpostCategory' => array(
                    'type' => 'array',
                    'default' => [],
                    'items'   => [
                        'type' => 'integer',
                ...
                'featuredcontentOption' => array(
                    'type' => 'boolean',
                    'default' => false
                ),
                'featuredcontentType' => array(
                    'type' => 'string',
                    'default' => 'excerpt'
                ),
                'featuredwordCount' => array(
                    'type' => 'integer',
                    'default' => 10
                ),
                'featuredorderBy' => array(
                    'type' => 'string',
                    'default' => 'date'
                ),
                'featuredorder' => array(
                ...
                'featureddateOption' => array(
                    'type' => 'boolean',
                    'default' => false
                ),
                'featuredauthorOption' => array(
                    'type' => 'boolean',
                    'default' => false
                ),
                'featuredcategoryOption' => array(
                    'type' => 'boolean',
                    'default' => false
                ),
                'featuredcategoriesCount' => array(
                    'type' => 'integer',
                    'default' => 2
                ),
                'featuredtagsOption' => array(
                    'type' => 'boolean',
                    'default' => false
                ),
                'featuredtagsCount' => array(
                    'type' => 'integer',
                    'default' => 2
                ),
                'featuredcommentOption' =>  array(
                    'type' => 'boolean',
                    'default' => false
                ),
                'carouselType'  => array(
                ...
                'sliderImagePosition'   => array(
                    'type'      => 'string',
                    'default'   => 'center center'
                ),
                'sliderImageDimension'  => array(
                    'type'      => 'string',
                    'default'   => 'full'
                ),
        ...
        public function render_callback( $attributes ) {
            ob_start();
                extract( $attributes );
            ?>
                <div id="wpmagazine-modules-lite-post-tiles-block-<?php echo esc_attr( $blockID ); ?>" class="wpmagazine-modules-lite-post-tiles-block align<?php echo esc_html( $align ); ?> block-<?php echo esc_attr( $blockID ); ?> cvmm-block cvmm-block-post-tiles--<?php echo esc_html( $blockLayout ); ?>">
                    <?php
                        if( !empty( $blockTitle ) ) {
    ...
    Wpmagazine_Modules_Lite_Post_Tiles::instance();
endif;