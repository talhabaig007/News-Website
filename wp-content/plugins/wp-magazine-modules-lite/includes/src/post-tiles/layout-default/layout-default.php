<?php
/**
 * Post Tiles block layout default - php render.
 */
        ...
        ?>
                <article post-id="post-<?php echo esc_attr( $post_id ); ?>" class="cvmm-post post-format--<?php echo esc_html( $post_format ); ?>" itemscope itemtype="<?php echo esc_url( 'http://schema.org/articleBody' ); ?>">
                    ...
                    <div class="cvmm-post-thumb">
                        <a href="<?php the_permalink(); ?>" target="<?php echo esc_html( $permalinkTarget ); ?>" style="background: url( <?php echo esc_url( $image_url ); ?> ); background-position: <?php echo esc_attr( $sliderImagePosition ); ?>; background-size: <?php echo esc_attr( $sliderImageSize ); ?>">
                        </a>
                    </div>
            ...
            <div class="cvmm-featured-post-wrapper">
                <?php
                    ...
                    $featured_post_args = array(
                        ...
                        'posts_per_page' => apply_filters( 'wpmagazine_modules_post_tiles_default_featured_post_count', 2 ),
